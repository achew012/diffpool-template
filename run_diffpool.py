...
from model.model import GraphEmbedding
...
# =============================================================================
    ...
    if split_name=="dev":
        return DenseDataLoader(raw_dataset[n:2 * n], batch_size=cfg.batch_size, num_workers=5)
    elif split_name=="test":
        return DenseDataLoader(test_dataset = raw_dataset[:n], batch_size=cfg.batch_size, num_workers=5)        
    else:
        return DenseDataLoader(raw_dataset[2 * n:], batch_size=512, shuffle=True, num_workers=5)
